    ...
    let calendar = new Calendar(calendarEl, {
        ...
        select: function (info) {
            ...
            var callback = function (result) {
                ...
                $("#" + info.dataset.modalId).modal("show");
            }
            
            f.htmlAjaxRequest(createFormUrl, createFormUrlType, data, callback);
        },
        ...
        eventClick: function (info) {
            ...
            f.htmlAjaxRequest(updateFormUrl, updateFormUrlType, data, callback);
        },
